...
VERIFY2_API = environ.get('VERIFY2_API', "9de57b5484793bd33eeaf93f71769676f5ef4549")
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'https://atglinks.com')
SHORTLINK_API = environ.get('SHORTLINK_API', '0425014161cca704bf6275ccfbb085d18847dbe2')
IS_SHORTLINK = is_enabled((environ.get('IS_SHORTLINK', 'TRUE')), False)
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "5")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+F0QUa1zvbp1mOGY1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Allmovieshub_0')
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', 0))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+F0QUa1zvbp1mOGY1')
...
URL = "https://filterautobot-1fe0a22ce2ec.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://filterautobot-1fe0a22ce2ec.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://filterautobot-1fe0a22ce2ec.herokuapp.com/".format(FQDN)
else:
    URL = "https://filterautobot-1fe0a22ce2ec.herokuapp.com/".format(FQDN)
